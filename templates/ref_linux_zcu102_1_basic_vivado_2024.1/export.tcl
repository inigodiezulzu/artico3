...
proc artico3_hw_setup {new_project_path new_project_name artico3_ip_dir} {
    ...
    if { [llength $new_project_name] > 0} {
        create_project -force $new_project_name $new_project_path -part xczu9eg-ffvb1156-2-e
    }
...
# VIVADO CONFIGURATION
    ...
    if {[string equal [get_runs -quiet synth_1] ""]} {
        create_run -name synth_1 -part xczu9eg-ffvb1156-2-e -flow {Vivado Synthesis 2024} -strategy "Vivado Synthesis Defaults" -constrset constrs_1
    } else {
...
# VIVADO CONFIGURATION
    ...
    if {[string equal [get_runs -quiet impl_1] ""]} {
        create_run -name impl_1 -part xczu9eg-ffvb1156-2-e -flow {Vivado Implementation 2024} -strategy "Vivado Implementation Defaults" -constrset constrs_1 -parent_run synth_1
    } else {
