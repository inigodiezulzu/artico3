...
<a3<=end generate=>a3>
    ...
    # Save checkpoint
    write_checkpoint -force $loc/top_A1_matmul_locked.dcp
...
<a3<=end generate=>a3>
    ...
    file rename "./$firstRP1/top_A1_artico3_recombined_partial.bit" "./$firstRP1bit/top_A1_artico3_recombined_partial.bit"
    puts "	#HD: Completed"
    close_project
