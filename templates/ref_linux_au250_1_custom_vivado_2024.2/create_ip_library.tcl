...
proc import_pcore { repo_path ip_name {libs ""} } {
    ...
    create_project -force $ip_name $temp_dir/$ip_name -part xcu250-figd2104-2L-e
...
create_project -force managed_ip_project $temp_dir/managed_ip_project -part xcu250-figd2104-2L-e -ip
